...
function ENT:Draw()
	...
	cam.Start3D2D( pos, ang, 0.1 )
		...
		surface.SetFont( "vs.mining.ui.50" )
		local tW, _ = surface.GetTextSize( text ) + w*.03
		draw.RoundedBox( 0, -tW / 2, -50, tW, 60, Color( 0, 0, 0, 188 ) )
		draw.SimpleText( text, "vs.mining.ui.50", 0, -24, ( t.color or color_white ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	cam.End3D2D()
end